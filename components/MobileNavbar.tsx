  ...
  return (
    <section className="w-full max-w-[264px]">
        <Sheet>
            ...
            <SheetContent side="left" className="border-none bg-white gap-2">
            <Link href="/" 
            className="flex cursor-pointer items-center gap-1 px-4">
                <Image src="/icons/logo.svg" width={34} height={34} alt="BiBiBank" />
                <h1 className="text-26 font-ibm-plex-serif font-bold text-black-1">BiBiBank</h1>
            </Link>
